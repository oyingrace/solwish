...
export default function Home() {
  return (
    <div className="min-h-min">
      ...
      <div className="absolute top-[39rem] left-0 w-full translate-y-6  justify-center items-start p-4">
        <div className="animate-bounce h-[200px] pl-4 pr-[17px] pt-4 pb-[17px] rounded-[10px] gap-10  justify-center items-center inline-flex">
